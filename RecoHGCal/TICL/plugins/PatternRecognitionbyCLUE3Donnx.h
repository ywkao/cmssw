...
#ifndef __RecoHGCal_TICL_PRbyCLUE3Donnx_H__
#define __RecoHGCal_TICL_PRbyCLUE3Donnx_H__
...
namespace ticl {
  ...
  class PatternRecognitionbyCLUE3Donnx final : public PatternRecognitionAlgoBaseT<TILES> {
  public:
    PatternRecognitionbyCLUE3Donnx(const edm::ParameterSet& conf, edm::ConsumesCollector);
    ~PatternRecognitionbyCLUE3Donnx() override = default;

    void makeTracksters(const typename PatternRecognitionAlgoBaseT<TILES>::Inputs& input,
                        std::vector<Trackster>& result,
                        std::unordered_map<int, std::vector<int>>& seedToTracksterAssociation) override;

    void energyRegressionORpId(const std::vector<reco::CaloCluster> &layerClusters,
  ...
  private:
    // TrackstersInference<TILES> onnx_model;
