...
// #include "RecoHGCal/TICL/plugins/TrackstersInference.h"

namespace ticl {
  template <typename TILES>
  class PatternRecognitionbyCLUE3D_onnx final : public PatternRecognitionAlgoBaseT<TILES> {
  public:
    PatternRecognitionbyCLUE3D_onnx(const edm::ParameterSet& conf, edm::ConsumesCollector);
    ~PatternRecognitionbyCLUE3D_onnx() override = default;
