...
#include "PatternRecognitionbyCLUE3Donnx.h"
...
DEFINE_EDM_VALIDATED_PLUGIN(PatternRecognitionFactory, ticl::PatternRecognitionbyCLUE3Donnx<TICLLayerTiles>, "CLUE3Donnx");
