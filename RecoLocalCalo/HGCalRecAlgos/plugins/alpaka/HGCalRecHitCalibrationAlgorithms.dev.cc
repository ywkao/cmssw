...
namespace ALPAKA_ACCELERATOR_NAMESPACE {
  ...
  class HGCalRecHitCalibrationAlgorithmsKernel {
  public:
  ...
  void HGCalRecHitCalibrationAlgorithms::fill(Queue& queue, portabletest::TestDeviceCollection& collection, double xvalue) const {
    ...
    alpaka::exec<Acc1D>(queue, workDiv, HGCalRecHitCalibrationAlgorithmsKernel{}, collection.view(), collection->metadata().size(), xvalue);
  }
